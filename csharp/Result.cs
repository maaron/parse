...
namespace Parse
{
    public class Result<T>
    {
        ...
        public bool IsSuccess { get { return result.IsLeft; } }
        public Success<T> Success { get { return result.Left; } }

        public bool IsFailure { get { return result.IsRight; } }
        public Failure<T> Failure { get { return result.Right; } }
    ...
    public class Result<T, V>
    {
        ...
        public bool IsSuccess { get { return result.IsLeft; } }
        public Success<T, V> Success { get { return result.Left; } }
